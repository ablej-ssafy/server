                ...
                .andDo(this.restDocs.document(resource(
                        ResourceSnippetParameters.builder()
                                ...
                                .pathParameters(
                                        ...
                                        fieldWithPath("data.description").type(JsonFieldType.STRING).description("회사 설명"),
                                        fieldWithPath("data.industryName").type(JsonFieldType.STRING).description("산업 분야"),
                                        fieldWithPath("data.link").type(JsonFieldType.STRING).optional().description("홈페이지"),
                                        fieldWithPath("data.age").type(JsonFieldType.NUMBER).description("기업 연혁"),
                                        fieldWithPath("data.foundedYear").type(JsonFieldType.NUMBER).description("설립 연도"),
